...
@Component({
  ...
  template: `
    <svg 
      ...
      <g *ngSwitchCase="'heart-filled'">
        <path fill="currentColor" stroke="none" d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"></path>
      </g>
      ...
      <g *ngSwitchCase="'apple'">
        <path fill="currentColor" stroke="none" d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M15.97 6.84c.62-.75 1.04-1.8 0.93-2.84-.9.04-2 .6-2.65 1.35-.58.67-1.09 1.74-.95 2.77 1 .08 2.05-.53 2.67-1.28z"></path>
      </g>
      ...
      <g *ngSwitchCase="'sparkles'">
        <path d="M12 3l1.912 5.885L20 10.8l-4.5 4.385 1.062 6.2L12 18.5 7.438 21.385l1.062-6.2L4 10.8l6.088-1.915L12 3z"></path>
      </g>
      ...
      <circle *ngSwitchDefault cx="12" cy="12" r="9"></circle>
    </svg>
  `
})
